  ...
  const MaterialUISwitch = styled(Switch)(({ theme }) => ({
    ...
    '& .MuiSwitch-switchBase': {
      ...
      '&.Mui-checked': {
        ...
        '& + .MuiSwitch-track': {
          opacity: 1,
          backgroundColor: theme.palette.mode === 'white' ? '#8BAA36' : '#8BAA36',
        },
      },
    },
    '& .MuiSwitch-thumb': {
      backgroundColor: theme.palette.mode === 'dark' ? '#8BAA36' : '#8BAA36',
      width: 32,
      height: 32,
      '&:before': {
        content: "''",
  ...
  <FormControlLabel
      ...
      {isMobile && showModal && <Modal onClose={setShowModal}>
        <MobileContainer>
          ...
          <NavLink to="/favorite">Favorites</NavLink>
          <NavLink to="/shopping-list">Shopping list</NavLink>
          <NavLink to="search"><SearchIcon sx={{ fontSize: 20}}/>Search</NavLink>
            </NavMenu>
          </PrimaryNav>
        </MobileContainer>
      </Modal>}
